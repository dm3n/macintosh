...
```
/design-shotgun "borrower document upload card"
/design-shotgun "mortgage application step progress bar"
/design-shotgun "income analysis data table row"
/design-shotgun components/apply/Step3.tsx   # redesign an existing component
```
...
Across sessions, internalize these preferences for Airbank:
